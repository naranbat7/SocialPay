...
import { Dimensions, View, ScrollView, SafeAreaView, StyleSheet, Text } from "react-native";
...
class InitScreen extends Component {
    ...
    render() {
        ...
        return (
            <SafeAreaView>
                <Name img={require('./../../../assets/images/hacker.png')} text={this.state.items.userName}/>
                <ScrollView style={{marginBottom: '37%'}}>
                    <View style={styles.infoCon}>
                        ...
                        <NonItem 
                            color= "#1068FF"
                            text="Банкны дансандаа мөнгөө авах" />
