...
export class SocialPinChecker extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidUpdate() {
    if (this.state.code.length == 4)
      if (!this.state.modalVisible) {
        ...
        axios
          .post(
            'http://192.168.205.168:8050/api/info/auth/pin/check',
            {pin: this.state.code},
            {
              headers: {
    ...
    return (
      <SafeAreaView style={css.container}>
        <View style={css.topContainer}>
          ...
          <Text style={css.parag}>нууц үгээ оруулна уу</Text>
...
export default SocialPinChecker;
